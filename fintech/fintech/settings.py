...
# locks out after 5 attempts
AXES_COOLOFF_TIME = 1
# locks out for a hour
AXES_LOCKOUT_TEMPLATE = 'locked.out.html'
AXES_ONLY_ADMIN_SITE = True
AXES_NEVER_LOCKOUT_WHITELIST = True
AXES_IP_WHITELIST = ['127.0.0.1'] 
AXES_URLS_PREFIX_WHITELIST = ['/api/token/'] 
...
Q_CLUSTER = {
    ...
    'queue_limit': 50,
    'bulk': 10,
    'orm': 'default',  # uses your existing database, no Redis needed
}
